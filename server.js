...
function simulateStudentGraduation(studentFactors) {
    ...
    for (let semester = 0; semester < semesters; semester++) {
        ...
        let semesterGpa = 3.0 * (studyHabits + health + familySupport) / 3.0 - 0.5 * courseDifficulty;
...
// POST route to calculate graduation probability
app.post('/calculate', (req, res) => {
    ...
    res.json({ graduation_probability: graduationProbability });
});
